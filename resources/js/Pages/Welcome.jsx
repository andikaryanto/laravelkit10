            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                <div className="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    {auth.user ? (
                        <Link
                            ...
                            className="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                        >
                            Dashboard
                        </Link>
                    ) : (
                        <>
                            ...
                            <Link
                                href={route('register')}
                                className="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                            >
                                Register
                            </Link>
                        </>
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray text-sm leading-relaxed">
                    ...
                    <div className="flex justify-center mt-16 px-6 sm:items-center sm:justify-between">
                        <div className="text-center text-sm text-gray-500 dark:text-gray sm:text-left">
                        ...
                        <div className="ml-4 text-center text-sm text-gray-500 dark:text-gray sm:text-right sm:ml-0">
